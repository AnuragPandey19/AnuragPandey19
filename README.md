...
**B.Tech Computer Science (AI/ML) — UPES, Dehradun**
...
🎓 B.Tech CSE (AI/ML), UPES Dehradun — graduating May 2027

💼 Recently: AI/ML Intern at **Notebrain Software & Services** (Aug–Oct 2025)

🛠️ Primarily a Python/Java developer with experience in ML pipelines, backend APIs, and database design
...
➜ [Repository](https://github.com/AnuragPandey19/Smart-City-Application-) · [Release v1.0](https://github.com/AnuragPandey19/Smart-City-Application-/releases)
...
➜ [Repository](https://github.com/AnuragPandey19/Rice-Disease-Detector) · [Live Demo](https://undebuggedbit-rice-leaf-disease-detector.hf.space/)

---

## Experience

**AI/ML Intern — Notebrain Software & Services Pvt. Ltd.** *(Aug 2025 – Oct 2025)*
Built and evaluated ML models for sports outcome prediction integrated into a production web application. Owned the end-to-end pipeline — data preprocessing, feature engineering, model training, validation.

**AI/ML Intern — Venture Launcher (Startup)** *(June 2025 – July 2025)*
Performed data analysis and preprocessing for an investor matching system. Built a prototype ML model for relevance matching as a proof of concept for the founding team.

---

## Leadership

**Core Member — UPES ACM & ACM-W Student Chapters**
Served as Program Head for ICPC Code Nexus, managing logistics and technical operations. Awarded Certificate of Appreciation for execution and contribution.
